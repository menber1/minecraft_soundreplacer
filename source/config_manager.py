...
class ConfigManager:
    ...
    def create_configfile(self):
        ...
        config['packformat'] = {
            'list_packformat': '1.21.7,64|1.21.6,63|1.21.5,55|1.21.4,46|1.21.3,42|1.21,34|1.20.6,32|1.20.4,22|1.20.2,18|1.20,15|1.19.4,13|1.19.3,12|1.19,9|1.18,8|1.17,7|1.16,6'
        }
        ...
        config['music'] = {
            'record': '11,13,5,blocks,cat,chirp,creator,creator_music_box,far,mall,mellohi,otherside,pigstep,precipice,relic,stal,strad,wait,ward,tears,lava_chicken',
